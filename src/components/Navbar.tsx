    ...
    return (
        <nav className='flex items-center justify-between flex-wrap bg-orange-200 p-6'>
            <div className='flex items-center flex-shrink-0 text-blue-800 mr-6'>
                <Link to='/' className='font-semibold text-xl tracking-tight'>Welcome to the Car Inventory</Link>
            </div>
            <div className='block'>
                <button onClick={dropDown} className='flex items-center px-3 py-2 text-blue-600 border rounded border-blue-600 hover:text-white hover:border-white'>
            ...
            <div className='w-full block flex-grow items-center'>
                <div className="text-sm lg:flex-grow">
                    <Button className='p-3 m-5 bg-orange-300 border rounded border-blue-800 justify-center'>
                        <div>
                            <Link to='/' onClick={ clicked} className='flex place-itmes-center mt-4 lg:inline-block lg:mt-0
                             text-blue-800 hover:text-white mr-4'>
                                Home
                            </Link>
                        </div>
                    ...
                    </Button>
                    {
                        ...
                        <Button className='p-3 m-5 bg-orange-300 border rounded border-blue-800 justify-center'>
                            <div>
                                ...
                                lg:inline-block lg:mt-0 text-blue-800 hover:text-white'>
                                    Login
                                </Link>
                            </div>
                        </Button>
